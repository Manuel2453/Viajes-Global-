...
/**
 * DTO (Data Transfer Object) que representa los detalles de un alojamiento (hotel).
 * Este objeto es utilizado para transferir la información relevante de un alojamiento
