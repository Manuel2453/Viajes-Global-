...
/**
 * DTO (Data Transfer Object) que representa los detalles de un traslado o servicio de transporte.
 * 
 * Esta clase contiene información sobre el traslado, como la ciudad, el origen, el destino, 
 * el tipo de transporte, el horario de disponibilidad, el precio, y otros detalles relacionados 
 * con el servicio de transporte. Se utiliza para transferir los datos entre las capas de la aplicación.
 */
